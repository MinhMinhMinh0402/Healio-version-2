...
import { Loader2, FileText, Calendar, Bot, User } from "lucide-react";
...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      <div className="flex items-center justify-center p-8">
        <Card className="w-full max-w-md bg-white shadow-xl">
          <CardHeader className="text-center space-y-2">
            ...
            <CardTitle className="text-2xl font-bold">Welcome to Healio</CardTitle>
            <p className="text-sm text-gray-500">Your Personal Health Platform</p>
          </CardHeader>
          <CardContent>
      ...
      <div className="hidden lg:flex flex-col bg-[#F7FCF9] p-12">
        <div className="mb-12">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <FeatureCard
            icon={Bot}
            title="AI Assistant"
            description="Get instant health advice powered by AI"
          />
          <FeatureCard
            icon={Calendar}
            title="Appointments"
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <select {...field} className="w-full h-10 rounded-md border bg-gray-50 px-3 py-2">
